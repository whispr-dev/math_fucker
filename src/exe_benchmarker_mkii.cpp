...
int main() {
    ...
    benchmark.addProgram("f[n]_is_least_no_k_and_a[n]_is_log2[n]_boosted.exe", "C:/users/phine/desktop/math_fucker/f[n]_is_least_no_k_and_a[n]_is_log2[n]_boosted.exe");
    benchmark.addProgram("f[n]_is_least_no_k_and_a[n]_is_log2[n]_boosted-2.exe", "C:/users/phine/desktop/math_fucker/f[n]_is_least_no_k_and_a[n]_is_log2[n]_boosted-2.exe");
    benchmark.addProgram("f[n]_is_least_no_k_and_a[n]_is_log2[n]_boosted-3.exe", "C:/users/phine/desktop/math_fucker/f[n]_is_least_no_k_and_a[n]_is_log2[n]_boosted-3.exe");
